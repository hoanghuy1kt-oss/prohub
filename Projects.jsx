...
const ScrollProgress = () => {
  return <motion.div className="fixed top-0 left-0 right-0 h-1 bg-black z-[100] origin-left" style={{ scaleX: 1 }} />;
};
...
export default function ProhubProjectsPage() {
  ...
  return (
    <div className="bg-white text-black font-sans selection:bg-black selection:text-white overflow-x-hidden min-h-screen">
        ...
        {isMenuOpen && (
            ...
            >
               {['About', 'Services', 'Projects', 'Contact'].map((item) => (
                  <a key={item} href="#" className="text-xl font-bold uppercase tracking-widest hover:text-orange-500">
                      {item}
                  </a>
               ))}
            </motion.div>
      ...
      {/* --- FOOTER --- */}
      <footer className="py-8 text-center text-xs text-gray-400 uppercase tracking-widest border-t border-gray-100">
         © 2026 PROHUB VIETNAM. All rights reserved.
      </footer>
    </div>
  );
}